        ...
        runOnUiThread(() -> {
                    ...
                    for (ClientMessage message : messages) {
                        ...
                        if (message.getSenderUsername().equals(this.presenter.getUsername())) {
                            if(isImage(message.getMessage())){
                                String str = message.getMessage();
                                content.addView(new ItemImageSend(this,message.getMessageId(),str.substring(4,str.length()-1)));
                            }else {
                            ...
                            if(isImage(message.getMessage())) {
                                String str = message.getMessage();
                                content.addView(new ItemImageReceive(this,message.getMessageId(),str.substring(4,str.length()-1)));
                            }else{
